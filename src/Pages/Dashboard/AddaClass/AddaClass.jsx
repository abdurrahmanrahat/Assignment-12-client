  ...
  return (
    <div>
      ...
      <form
        ...
        className="md:w-2/3 mx-4 md:mx-auto"
      >
        ...
        <div className="md:flex gap-8 md:mb-4">
          ...
          <div className="form-control w-full">
            ...
            <input
              ...
              {...register("classNameSpe", { required: true })}
              className="input input-bordered w-full "
            />
          </div>
        ...
        <div className="text-center my-10">
          <input
            className="btn btn-outline mt-4 text-lg bg-[#FFBD00] hover:bg-[#0E0C1A] text-black hover:text-white"
            type="submit"
            value="Add Class"
          />
        </div>
