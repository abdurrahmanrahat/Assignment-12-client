        ...
        {user ? (
          <>
            ...
            <button
              ...
              className="btn btn-active text-lg bg-[#FFBD00] hover:bg-[#0E0C1A] text-white border-none"
            >
              logOut
            </button>
          </>
          ...
          <Link to="/login">
            <button className="btn btn-active text-lg bg-[#FFBD00] hover:bg-[#0E0C1A] text-white border-none">
              Login
            </button>
          </Link>
        )}
